...
const envSchema = z.object({
  ...
  // Site Configuration
  VITE_SITE_URL: z.string().optional().transform(val => val || 'https://anoteroslogos.com').pipe(z.string().url()),
  ...
  VITE_AUTH_REDIRECT_URL: z.string().optional().transform(val => val || 'https://anoteroslogos.com/auth/callback').pipe(z.string().url()),
