    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-xl bg-purple-500/10 border border-purple-500/30">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-purple-300 mb-2">AI-Powered Schema Generation</h4>
            <p className="text-sm text-white/70">
              Our GEO Marketolog AI Agent generates production-ready Schema.org markup optimized for maximum 
              AI system visibility and citation likelihood. Schemas are automatically validated and include 
              knowledge graph connections for enhanced entity recognition.
            </p>
          </div>
        </div>
      </div>
